...
export default function Footer() {
  return (
    <footer className="border-t border-hairline py-8 mt-12 text-muted">
      <div className="max-w-[1120px] mx-auto px-6 flex flex-col sm:flex-row items-center justify-between gap-4 text-[13px]">
        <div className="flex items-center gap-2">
          <span className="w-5 h-5 rounded-full bg-accent flex items-center justify-center text-accent-ink">
            <Link2 className="w-3 h-3" strokeWidth={2.5} />
          </span>
          <span className="font-heading font-semibold text-body">
            QuickLink
          </span>
        </div>
        ...
        <div className="flex items-center gap-6 font-medium text-muted">
          ...
          <Link to="/lookup" className="hover:text-ink transition-colors">
            Analytics
          </Link>
          <a
        ...
        <span className="text-faint">© 2026 QuickLink</span>
      </div>
    </footer>
  );
}
